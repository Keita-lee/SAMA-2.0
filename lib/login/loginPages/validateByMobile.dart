...
class ValidateByMobile extends StatefulWidget {
  String? email;
  Function(int) changePage;
  ValidateByMobile({super.key, required this.email, required this.changePage});

  @override
  State<ValidateByMobile> createState() => _ValidateByMobileState();
}

class _ValidateByMobileState extends State<ValidateByMobile> {
  // Text controllers
...
//Check if otp valid
  validate() async {
    await confirmationResult
        .confirm(otp.text)
        .then((value) => widget.changePage(5))
