...
class AddEventsImage extends StatefulWidget {
  ...
  @override
  State<AddEventsImage> createState() => _AddEventsImageState();
}

class _AddEventsImageState extends State<AddEventsImage> {
